...
const showCustomTransition = ref(false)
...
<template>
  <div class="md-example-child md-example-child-landscape">
    ...
    <md-button @click="showMaskClosable = true"
      >点击蒙层关闭</md-button
    >
    <md-landscape
      v-model="showMaskClosable"
      :mask-closable="true"
    >
      <img
        src="//manhattan.didistatic.com/static/manhattan/do1_6VL7HL8TYaUMsIfygfpz"
    ...
    <md-button @click="showFullScreen = true"
      >全屏</md-button
    >
    ...
    <md-button @click="showListen = true"
      >监听事件</md-button
    >
    <md-landscape
      v-model="showListen"
    ...
    <md-button @click="showCustomTransition = true"
      >自定义动画</md-button
    >
    <md-landscape
      v-model="showCustomTransition"
