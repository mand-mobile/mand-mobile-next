<template>
  ...
  >
  <!-- <div class="md-scroll-view-primitive md-scroll-view"
    @touchstart.prevent="$_onScrollerTouchStart"
    @touchmove.prevent="$_onScrollerTouchMove"
    @touchend.prevent="$_onScrollerTouchEnd"
    @touchcancel.prevent="$_onScrollerTouchEnd"
  > -->
    <div
      class="md-scroll-view-container"
      :class="{
        'horizon': scrollingX && !scrollingY,
        'refresh-enable': refresherEnable
      }"
...
import PulldownRefresh from 'mand-mobile/_scroller/pull-down'
import {throttle, flatStyleObject} from 'mand-mobile/_util'
...
export default {
  ...
  methods: {
    $_initScroller() {
      ...
      this.content = this.wrapper.querySelector('.md-scroll-view-container')
      this.refresher = this.wrapper.querySelector('.scroll-view-refresh')
      this.more = this.wrapper.querySelector('.scroll-view-more')
