<template>
  <div class="md-example-child md-example-child-landscape">
    <md-button size="small" inline @click="showPic=true">图片广告</md-button>
    <md-landscape v-model="showPic">
      <img mode="widthFix" src="//manhattan.didistatic.com/static/manhattan/do1_6VL7HL8TYaUMsIfygfpz">
    </md-landscape>

    <md-button size="small" inline @click="showMaskClosable=true">点击蒙层关闭</md-button>
    <md-landscape v-model="showMaskClosable" :mask-closable="true">
      <img mode="widthFix"  src="//manhattan.didistatic.com/static/manhattan/do1_6VL7HL8TYaUMsIfygfpz">
    </md-landscape>

    <md-button size="small" inline @click="showFullScreen=true">全屏</md-button>
    ...
    <md-button size="small" inline @click="showNoMask=true">无蒙层</md-button>
    <md-landscape v-model="showNoMask" :has-mask="false">
      <img mode="widthFix" src="//manhattan.didistatic.com/static/manhattan/do1_6VL7HL8TYaUMsIfygfpz">
    </md-landscape>

    <md-button size="small" inline @click="showListen=true">监听事件</md-button>
    <md-landscape v-model="showListen" @show="alert('已弹出')" @hide="alert('已隐藏')">
      <img mode="widthFix" src="//manhattan.didistatic.com/static/manhattan/do1_6VL7HL8TYaUMsIfygfpz">
    </md-landscape>

    <md-button size="small" inline @click="showCustomTransition=true">自定义动画</md-button>
