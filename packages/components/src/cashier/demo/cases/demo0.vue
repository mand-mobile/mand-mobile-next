...
.md-example-child-cashier .md-cashier-channel-item .cashier-icon-1 {
...
.md-example-child-cashier .md-cashier-channel-item .cashier-icon-2 {
...
.md-example-child-cashier .md-cashier-channel-item .cashier-icon-3 {
...
.md-example-child-cashier .md-cashier-channel-item .cashier-icon-4 {
