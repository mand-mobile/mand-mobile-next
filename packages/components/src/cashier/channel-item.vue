...
// 避免shadow dom不能穿透，将外置样式改成内置
.md-cashier-channel-item_icon.cashier-icon-1 {
...
.md-cashier-channel-item_icon.cashier-icon-2 {
...
.md-cashier-channel-item_icon.cashier-icon-3 {
...
.md-cashier-channel-item_icon.cashier-icon-4 {
...
.md-cashier-channel-item_icon.cashier-icon-5 {
